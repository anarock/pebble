...
var pebbleShared = require("pebble-shared");
...
var constants = {
  ...
  border: {
    base: "1px solid ".concat(pebbleShared.colors.gray.light),
    light: "1px solid ".concat(pebbleShared.colors.gray.lighter)
  },
  boxShadow: {
    base: "0 2px 7px 0 #F2F2F2",
    elevated: "0 4px 7px 0 ".concat(pebbleShared.colors.gray.light),
...
var typography = {
  xll: {
    regular: {
      fontWeight: 400,
      color: pebbleShared.colors.gray.darker,
...
var violet = pebbleShared.colors.violet,
  gray = pebbleShared.colors.gray,
  white = pebbleShared.colors.white,
  red = pebbleShared.colors.red,
  emerald = pebbleShared.colors.emerald;
...
var dropDownButtonStyle =
  ...
  emotion.css({
    ...
    "&:not([disabled]):hover": {
      backgroundColor: pebbleShared.colors.gray.lighter
    }
  });
...
var Loader = function Loader(_ref) {
  var _ref$color = _ref.color,
    color =
      _ref$color === void 0 ? pebbleShared.colors.gray.darker : _ref$color,
...
var tileStyle =
  ...
  emotion.css(
    _objectSpread({}, typography.normal.regular, {
      ...
      border: "1px solid ".concat(pebbleShared.colors.white.base),
      borderLeft: 0,
      borderTop: 0,
      time: {
        fontFamily: "inherit"
      ...
      "&.react-calendar__tile--active": {
        backgroundColor: pebbleShared.colors.violet.lightest,
        color: pebbleShared.colors.violet.base
      },
      "&.react-calendar__tile--rangeStart": {
        backgroundColor: pebbleShared.colors.violet.base,
        color: "".concat(pebbleShared.colors.white.base, " !important")
      },
...
var dateStyle =
  ...
  emotion.css({
    ...
    ".react-calendar__navigation__arrow": {
      border: "1px solid ".concat(pebbleShared.colors.gray.light),
      padding: "8px 10px",
      borderRadius: constants.borderRadius,
      alignItems: "center",
      display: "flex",
        ...
        value: function render() {
          ...
          return React.createElement(
            ...
            React.createElement(
              reactPopper.Manager,
              null,
              React.createElement(reactPopper.Reference, null, function(_ref) {
                var ref = _ref.ref;
                return React.createElement(
                  "div",
                  {
...
var inputStyle =
  ...
  emotion.css(
    _objectSpread(
      ...
      /*#__PURE__*/
      getPlaceholderStyle(pebbleShared.colors.gray.light)
    )
  );
...
function getColor(error, success, isUnderlineColor) {
  var color = pebbleShared.colors.gray.dark;
  if (error) {
    color = pebbleShared.colors.red.base;
  } else if (success) {
    color = pebbleShared.colors.emerald.base;
    ...
    _createClass(Input, [
      {
        ...
        value: function render() {
          ...
          var _inputClassName = emotion.cx(
            inputStyle,
            ((_cx = {}),
...
var searchStyle =
  ...
  emotion.css(
    _objectSpread(
      ...
      typography.s.regular,
      /*#__PURE__*/
      getPlaceholderStyle(pebbleShared.colors.gray.base),
      {
        backgroundColor: "transparent"
      }
    )
...
var clearContainer =
  ...
  emotion.css({
    ...
    height: 16,
    width: 16,
    backgroundColor: pebbleShared.colors.gray.light,
    fontSize: 6,
    borderRadius: 16,
    textAlign: "center",
    cursor: "pointer",
    ...
    _createClass(OptionGroup, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          var searchBoxClassName = emotion.cx(
            searchBoxWrapper,
...
var rheostatOverrides = "\n.rheostat {\n  overflow: visible;\n}\n\n.rheostat-background {\n  background-color: "
  .concat(
    pebbleShared.colors.violet.lightest,
    ";\n  position: relative;\n  border-radius: 2px;\n  overflow: hidden;\n  height: 4px;\n  top: 0;\n  width: 100%;\n}\n\n.rheostat-progress {\n  background-color: "
  )
  .concat(
    pebbleShared.colors.violet.base,
    ";\n  position: absolute;\n  height: 4px;\n  border-radius: 2px;\n  top: 0;\n}\n\n.rheostat-handle {\n  background-color: "
  )
  .concat(
    pebbleShared.colors.violet.base,
  ...
  .concat(
    pebbleShared.colors.violet.light,
    ";\n}\n\n.__pebble__slider__disabled .rheostat-handle {\n  background-color: "
  )
  .concat(
    pebbleShared.colors.violet.lighter,
    ";\n  cursor: inherit;\n}\n\n.rheostat-horizontal {\n  height: 4px;\n}\n"
  );
var sliderHeader =
  /*#__PURE__*/
...
var headingStyle =
  /*#__PURE__*/
  emotion.css(_objectSpread({}, typography.normal.regular));
var dotStyle$1 =
  /*#__PURE__*/
  emotion.css({
    height: 20,
    width: 20,
    backgroundColor: pebbleShared.colors.gray.base,
    borderRadius: "50%",
...
var iconClass =
  ...
  emotion.css({
    ...
    position: "relative",
    ":hover": {
      backgroundColor: pebbleShared.colors.violet.lighter,
...
var Tag = function Tag(_ref) {
  ...
  return React.createElement(
    "div",
    {
      className: _className,
      style: {
        color: pebbleShared.colors[color].base,
        backgroundColor:
          pebbleShared.colors[color].lightest ||
          pebbleShared.colors[color].light
      }
    },
    label,
    " ",
...
var emitter =
  ...
  new Mitt();
var _colors = {
  success: pebbleShared.colors.emerald.base,
  error: pebbleShared.colors.red.base
};
          ...
          value: function getDerivedStateFromProps(props, state) {
            ...
            if (props.value && props.value !== state.propsValue) {
              newState = {
                ...
                stringInput:
                  (props.value && dateFns.format(props.value, "DD/MM/YYYY")) ||
                  ""
              };
            }
            return newState;
...
default_1.defaultProps = {
  placement: "bottom",
  popperBackgroundColor: pebbleShared.colors.white.base,
  closeOnOutsideClick: true
};
          ...
          return React.createElement(
            default_1,
            {
              ...
              popperBackgroundColor: isError
                ? pebbleShared.colors.red.base
                : pebbleShared.colors.gray.darker,
              modifiers: modifiers,
    ...
    _objectSpread(
      ...
      typography.normal.regular,
      {
        "&[data-disabled='true']": _defineProperty(
          ...
          {
            color: pebbleShared.colors.gray.light
          }
        )
      }
    )
...
var ControlView = function ControlView(_ref) {
  ...
  var getColor = function getColor() {
    if (disabled) {
      return pebbleShared.colors.gray.base;
    }
    if (checked) {
      return pebbleShared.colors.violet.base;
    }
    return pebbleShared.colors.gray.light;
  };
  return React.createElement(
    React.Fragment,
    null,
  ...
  rightElement: function rightElement(_ref) {
    ...
    var iconClass = emotion.cx(
      ...
      emotion.css({
        ...
        color: isSelected
          ? pebbleShared.colors.violet.base
          : pebbleShared.colors.gray.light,
        fontSize: "20px"
      })
    );
    return multiSelect
...
var timePickerWrap =
  ...
  emotion.css({
    ...
    cursor: "pointer",
    "&:not([disabled]):hover": {
      background: pebbleShared.colors.gray.light
    }
  });
...
var Message = function Message(_ref) {
  ...
  return React.createElement(
    "div",
    {
      className: emotion.cx(messageWrapper, className),
      style: {
        backgroundColor: bColor
      }
    },
...
exports.colors = pebbleShared.colors;
exports.utils = index;
